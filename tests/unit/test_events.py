...
class EventsTest(unittest.TestCase):
    ...
    def test_highest_altitudes(self):
        ...
        self.assertAlmostEqual(venus_event["altitude"], 48.24, delta=0.01)
    ...
    def test_calculate_moon_messier_conjunctions(self, mock_find_conjs):
        ...
        # Assert
        # It should call find_conjunctions_with_stars once for all Messier objects
        self.assertEqual(mock_find_conjs.call_count, 1)
        self.assertGreater(len(events_df), 0)
    ...
    def test_conjunction_precomputation_usage(self, mock_find_conj):
        ...
        for call in mock_find_conj.call_args_list:
            ...
            # Verify the precomputed position's time array matches the expected length for 2-minute resolution
            # duration = 1 day = 1440 minutes. resolution = 2 minutes.
            # num_steps = 1440 / 2 = 720
