...
from .base import FilterHolder, FilterWheel
...
_merge_vendors(FilterWheel)
_merge_vendors(FilterHolder)

__all__ = ["FilterWheel", "FilterHolder", "normalize_filter_wheel_database_entry"]
