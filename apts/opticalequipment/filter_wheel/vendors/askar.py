...
class AskarFilterWheel(FilterWheel):
    _DATABASE = {'Askar_Filter_Wheel_5x_M42': {'brand': 'Askar', 'name':
        'Filter Wheel 5x (M42)', 'type': 'type_filter_wheel',
        'optical_length': 19, 'mass': 310, 'tside_thread': 'M42',
        'tside_gender': 'Female', 'cside_thread': 'M42', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': ''},
        'Askar_Filter_Wheel_7x_M48': {'brand': 'Askar', 'name':
        ...
        'Male', 'reversible': False, 'bf_role': ''},
        'Askar_Filter_Wheel_7x_M54': {'brand': 'Askar', 'name':
