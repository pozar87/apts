...
class CelestronFilterWheel(FilterWheel):
    _DATABASE = {'Celestron_Filter_Wheel_5x_M42': {'brand': 'Celestron',
        'name': 'Filter Wheel 5x (M42)', 'type': 'type_filter_wheel',
        ...
        'Celestron_Filter_Wheel_7x_M48': {'brand': 'Celestron', 'name':
...
class CelestronFilterHolder(FilterHolder):
    _DATABASE = {'Celestron_Filter_Slide_1_25': {'brand': 'Celestron',
        'name': 'Filter Slide 1.25"', 'type': 'type_filter_holder',
        'optical_length': 8, 'mass': 100, 'tside_thread': '1.25"',
