...
class AtikFilterWheel(FilterWheel):
    _DATABASE = {'Atik_EFW2_M42': {'brand': 'Atik', 'name': 'EFW2 (M42)',
        'type': 'type_filter_wheel', 'optical_length': 20, 'mass': 350,
        'tside_thread': 'M42', 'tside_gender': 'Female', 'cside_thread':
        'M42', 'cside_gender': 'Male', 'reversible': False, 'bf_role': ''},
        'Atik_EFW3_M54': {'brand': 'Atik', 'name': 'EFW3 (M54)', 'type':
        'type_filter_wheel', 'optical_length': 20, 'mass': 550,
