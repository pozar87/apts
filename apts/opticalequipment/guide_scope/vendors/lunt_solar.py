...
class LuntSolarGuideScope(GuideScope):
    _DATABASE = {'Lunt_Solar_Guide_Scope_50mm': {'brand': 'Lunt Solar',
        'name': 'Guide Scope 50mm', 'type': 'type_guide_scope',
        'optical_length': 0, 'mass': 270, 'tside_thread': '',
        'tside_gender': 'Male', 'cside_thread': 'M42', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': ''},
        'Lunt_Solar_Guide_Scope_50mm_Solar': {'brand': 'Lunt Solar', 'name':
        'Guide Scope 50mm Solar', 'type': 'type_guide_scope',
        'optical_length': 0, 'mass': 280, 'tside_thread': '',
        'tside_gender': 'Male', 'cside_thread': 'M42', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': ''}}
