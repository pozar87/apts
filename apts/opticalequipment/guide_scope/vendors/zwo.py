...
class ZWOGuideScope(GuideScope):
    _DATABASE = {'ZWO_30mm_Mini_Guide_Scope': {'brand': 'ZWO', 'name':
        '30mm Mini Guide Scope', 'type': 'type_guide_scope',
        'optical_length': 0, 'mass': 150, 'tside_thread': '',
        'tside_gender': 'Male', 'cside_thread': 'CS', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': ''}, 'ZWO_60mm_Guide_Scope':
        {'brand': 'ZWO', 'name': '60mm Guide Scope', 'type':
        'type_guide_scope', 'optical_length': 0, 'mass': 350,
        'tside_thread': '', 'tside_gender': 'Male', 'cside_thread': 'M42',
        'cside_gender': 'Male', 'reversible': False, 'bf_role': ''},
        'ZWO_120mm_Guide_Scope': {'brand': 'ZWO', 'name':
        '120mm Guide Scope', 'type': 'type_guide_scope', 'optical_length': 
        0, 'mass': 500, 'tside_thread': '', 'tside_gender': 'Male',
