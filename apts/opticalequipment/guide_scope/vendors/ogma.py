...
class OGMAGuideScope(GuideScope):
    _DATABASE = {'OGMA_Guide_Scope_30mm': {'brand': 'OGMA', 'name':
        'Guide Scope 30mm', 'type': 'type_guide_scope', 'optical_length': 0,
        'mass': 120, 'tside_thread': '', 'tside_gender': 'Male',
        'cside_thread': 'CS', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'OGMA_Guide_Scope_60mm': {'brand': 'OGMA', 'name':
