...
class OrionGuideScope(GuideScope):
    _DATABASE = {'Orion_50mm_Guide_Scope': {'brand': 'Orion', 'name':
        ...
        'bf_role': ''}, 'Orion_60mm_Guide_Scope': {'brand': 'Orion', 'name':
        '60mm Guide Scope', 'type': 'type_guide_scope', 'optical_length': 0,
        'mass': 340, 'tside_thread': '', 'tside_gender': 'Male',
        'cside_thread': 'M42', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Orion_Mini_50mm_Guide_Scope': {'brand': 'Orion',
        'name': 'Mini 50mm Guide Scope', 'type': 'type_guide_scope',
        'optical_length': 0, 'mass': 260, 'tside_thread': '',
        'tside_gender': 'Male', 'cside_thread': 'M42', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': ''},
        'Orion_Deluxe_60mm_Guide_Scope': {'brand': 'Orion', 'name':
        'Deluxe 60mm Guide Scope', 'type': 'type_guide_scope',
