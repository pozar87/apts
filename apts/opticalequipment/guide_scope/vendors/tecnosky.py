...
class TecnoskyGuideScope(GuideScope):
    _DATABASE = {'Tecnosky_30mm_Guide_Scope': {'brand': 'Tecnosky', 'name':
        '30mm Guide Scope', 'type': 'type_guide_scope', 'optical_length': 0,
        'mass': 110, 'tside_thread': '', 'tside_gender': 'Male',
        'cside_thread': 'CS', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Tecnosky_60mm_Guide_Scope': {'brand': 'Tecnosky',
