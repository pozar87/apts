...
class AskarFlattener(Flattener):
    _DATABASE = {'Askar_Full_frame_Flattener': {'brand': 'Askar', 'name':
        'Full-frame Flattener', 'type': 'type_flattener', 'optical_length':
        0, 'mass': 250, 'tside_thread': 'M48', 'tside_gender': 'Female',
        'cside_thread': 'M48', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': 'start'}, 'Askar_2_Flattener_M48': {'brand': 'Askar',
        'name': '2" Flattener (M48)', 'type': 'type_flattener',
...
class AskarCorrector(Corrector):
    _DATABASE = {'Askar_Color_Magic_Corrector': {'brand': 'Askar', 'name':
        'Color-Magic Corrector', 'type': 'type_corrector', 'optical_length':
