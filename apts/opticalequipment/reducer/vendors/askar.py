...
class AskarReducer(Reducer):
    _DATABASE = {
        ...
        'Askar_103APO_Reducer_0_8x': {'brand': 'Askar', 'name': '103APO Reducer 0.8x', 'type': 'type_reducer', 'optical_length': 0, 'mass': 480, 'tside_thread': 'M84', 'tside_gender': 'Female', 'cside_thread': 'M48', 'cside_gender': 'Female', 'reversible': False, 'bf_role': 'start', 'required_backfocus': 55},
