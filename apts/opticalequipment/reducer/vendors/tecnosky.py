...
class TecnoskyReducer(Reducer):
    _DATABASE = {'Tecnosky_0_8x_Reducer_M48': {'brand': 'Tecnosky', 'name':
...
class TecnoskyFlattener(Flattener):
    _DATABASE = {'Tecnosky_Field_Flattener_M48': {'brand': 'Tecnosky',
        'name': 'Field Flattener (M48)', 'type': 'type_flattener',
...
class TecnoskyCorrector(Corrector):
    _DATABASE = {'Tecnosky_Wynne_Corrector_M68': {'brand': 'Tecnosky',
        'name': 'Wynne Corrector (M68)', 'type': 'type_corrector',
