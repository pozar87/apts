...
class GsoFlattener(Flattener):
    _DATABASE = {'GSO_2_Field_Flattener': {'brand': 'GSO', 'name':
        '2" Field Flattener', 'type': 'type_flattener', 'optical_length': 0,
...
class GsoCorrector(Corrector):
    _DATABASE = {'GSO_Coma_Corrector_M48': {'brand': 'GSO', 'name':
        'Coma Corrector (M48)', 'type': 'type_corrector', 'optical_length':
        0, 'mass': 230, 'tside_thread': 'M48', 'tside_gender': 'Female',
        'cside_thread': 'M48', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': 'start'}}
