...
class TecReducer(Reducer):
    _DATABASE = {'TEC_TEC_140_Reducer_0_72x': {'brand': 'TEC', 'name':
        'TEC-140 Reducer 0.72x', 'type': 'type_reducer', 'optical_length': 
        0, 'mass': 350, 'tside_thread': 'M68', 'tside_gender': 'Female',
        'cside_thread': 'M68', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': 'start'}, 'TEC_TEC_180_Reducer_0_72x': {'brand': 'TEC',
        'name': 'TEC-180 Reducer 0.72x', 'type': 'type_reducer',
        'optical_length': 0, 'mass': 450, 'tside_thread': 'M68',
...
class TecFlattener(Flattener):
    _DATABASE = {'TEC_TEC_110_Flattener': {'brand': 'TEC', 'name':
        'TEC-110 Flattener', 'type': 'type_flattener', 'optical_length': 0,
        'mass': 280, 'tside_thread': 'M54', 'tside_gender': 'Female',
        'cside_thread': 'M54', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': 'start'}, 'TEC_TEC_160_Flattener': {'brand': 'TEC',
        'name': 'TEC-160 Flattener', 'type': 'type_flattener',
        'optical_length': 0, 'mass': 400, 'tside_thread': 'M68',
        'tside_gender': 'Female', 'cside_thread': 'M68', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': 'start'}}
