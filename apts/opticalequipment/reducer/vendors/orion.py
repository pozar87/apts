...
class OrionReducer(Reducer):
    _DATABASE = {'Orion_0_85x_Reducer': {'brand': 'Orion', 'name':
        '0.85x Reducer', 'type': 'type_reducer', 'optical_length': 0,
        'mass': 220, 'tside_thread': 'M48', 'tside_gender': 'Female',
        'cside_thread': 'M48', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': 'start'}, 'Orion_0_5x_Focal_Reducer': {'brand': 'Orion',
        'name': '0.5x Focal Reducer', 'type': 'type_reducer',
        'optical_length': 0, 'mass': 300, 'tside_thread': '1.25"',
