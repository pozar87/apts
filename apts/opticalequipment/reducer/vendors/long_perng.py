...
class Long_perngReducer(Reducer):
    _DATABASE = {'Long_Perng_0_79x_Reducer_M48': {'brand': 'Long Perng',
        'name': '0.79x Reducer (M48)', 'type': 'type_reducer',
...
class Long_perngFlattener(Flattener):
    _DATABASE = {'Long_Perng_Field_Flattener_M48': {'brand': 'Long Perng',
