...
class OmegonReducer(Reducer):
    _DATABASE = {'Omegon_0_8x_Reducer_M48': {'brand': 'Omegon', 'name':
...
class OmegonFlattener(Flattener):
    _DATABASE = {'Omegon_Field_Flattener_M48': {'brand': 'Omegon', 'name':
...
class OmegonCorrector(Corrector):
    _DATABASE = {'Omegon_Coma_Corrector_M48': {'brand': 'Omegon', 'name':
