...
class BaaderReducer(Reducer):
    _DATABASE = {'Baader_Alan_Gee_II_Telecompressor': {'brand': 'Baader',
        'name': 'Alan Gee II Telecompressor', 'type': 'type_reducer',
        'optical_length': 0, 'mass': 200, 'tside_thread': 'M42',
...
class BaaderCorrector(Corrector):
    _DATABASE = {'Baader_MPCC_Mark_III': {'brand': 'Baader', 'name':
        'MPCC Mark III', 'type': 'type_corrector', 'optical_length': 0,
        'mass': 200, 'tside_thread': 'M48', 'tside_gender': 'Female',
        'cside_thread': 'M48', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': 'start'}, 'Baader_RCC_I_Coma_Corrector': {'brand':
        'Baader', 'name': 'RCC I (Coma Corrector)', 'type':
        ...
        'Baader_3_RCC_for_RC_telescopes': {'brand': 'Baader', 'name':
        '3" RCC (for RC telescopes)', 'type': 'type_corrector',
        'optical_length': 0, 'mass': 500, 'tside_thread': 'M68',
        'tside_gender': 'Female', 'cside_thread': 'M68', 'cside_gender':
        'Male', 'reversible': False, 'bf_role': 'start'},
        'Baader_MPCC_III_1_1': {'brand': 'Baader', 'name': 'MPCC III (1:1)',
        'type': 'type_corrector', 'optical_length': 0, 'mass': 200,
        'tside_thread': 'M48', 'tside_gender': 'Female', 'cside_thread':
        'M48', 'cside_gender': 'Male', 'reversible': False, 'bf_role': 'start'}
        }
