...
class ApmReducer(Reducer):
    _DATABASE = {'APM_Riccardi_Design_0_75x': {'brand': 'APM', 'name':
        'Riccardi-Design 0.75x', 'type': 'type_reducer', 'optical_length': 
        0, 'mass': 450, 'tside_thread': 'M72', 'tside_gender': 'Female',
...
class ApmCorrector(Corrector):
    _DATABASE = {'APM_Comacorr_1x_M48': {'brand': 'APM', 'name':
        'Comacorr 1x (M48)', 'type': 'type_corrector', 'optical_length': 0,
