...
class AskarTelescope(Telescope):
    _DATABASE = {
        ...
        'Askar_FRA400': {'brand': 'Askar', 'name': 'FRA400', 'type': 'type_refractor', 'optical_length': 0, 'mass': 3200, 'tside_thread': '', 'tside_gender': '', 'cside_thread': 'M48', 'cside_gender': 'Male', 'reversible': False, 'bf_role': '', 'aperture_mm': 72, 'focal_length_mm': 400}, # Verified via specs (3.2kg total weight)
