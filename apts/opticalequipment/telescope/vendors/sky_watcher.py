...
class Sky_watcherTelescope(Telescope):
    _DATABASE = {   'Sky_Watcher_150PDS_Newtonian': {   'bf_role': '',
                                        'brand': 'Sky-Watcher',
                                        'cside_gender': 'Male',
                                        'cside_thread': '2"',
                                        'mass': 4800,
    ...
    'Sky_Watcher_Evostar_72ED_DS_Pro': {   'bf_role': '',
                                           ...
                                           'tside_thread': '',
                                           'type': 'type_refractor'},
    'Sky_Watcher_Evostar_80ED': {   'bf_role': '',
                                    'brand': 'Sky-Watcher',
                                    'cside_gender': 'Male',
                                    'cside_thread': 'M48',
                                    'mass': 2500,
    ...
    'Sky_Watcher_Quattro_150P': {   'aperture_mm': 150,
                                    ...
                                    'vendor': 'Sky-Watcher Quattro 150P'},
    'Sky_Watcher_Quattro_200P': {   'aperture_mm': 200,
                                    ...
                                    'tside_thread': '',
                                    'type': 'newtonian_reflector',
                                    'vendor': 'Sky-Watcher Quattro 200P'},
    'Sky_Watcher_Quattro_250P': {   'aperture_mm': 250,
                                    'bf_role': '',
                                    'brand': 'Sky-Watcher',
                                    ...
                                    'tside_thread': '',
                                    'type': 'newtonian_reflector',
                                    'vendor': 'Sky-Watcher Quattro 250P'},
    'Sky_Watcher_Quattro_300P': {   'aperture_mm': 300,
                                    'bf_role': '',
                                    'brand': 'Sky-Watcher',
                                    ...
                                    'tside_thread': '',
                                    'type': 'newtonian_reflector',
                                    'vendor': 'Sky-Watcher Quattro 300P'},
