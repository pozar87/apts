...
class Sky_watcherTelescope(Telescope):
    _DATABASE = {
        ...
        'Sky_Watcher_Explorer_150P': {'aperture_mm': 150,
         ...
         'tside_gender': '',
         'tside_thread': '',
         'type': 'newtonian_reflector'},  # Verified via manufacturer technical specs (47mm CO, 5.9kg OTA) https://www.apm-telescopes.net/en/skywatcher-explorer-150p-newtonian-reflector-ota
