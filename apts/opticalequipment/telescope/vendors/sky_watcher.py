...
class Sky_watcherTelescope(Telescope):
    _DATABASE = {
        ...
        'Sky_Watcher_200PDS_Newtonian': {'aperture_mm': 200,
         ...
         'tside_thread': '',
         'type': 'newtonian_reflector'},
        'Sky_Watcher_250PDS_Newtonian': {'aperture_mm': 250,
         'bf_role': '',
         'brand': 'Sky-Watcher',
        ...
        'Sky_Watcher_Explorer_250P': {'aperture_mm': 254,
         ...
         'tside_gender': '',
         'tside_thread': '',
         'type': 'newtonian_reflector'}, # Verified via manufacturer technical specs (58mm CO, 14kg OTA)
        ...
        'Sky_Watcher_Heritage_150P': {
            ...
            'tside_gender': '',
            'tside_thread': '',
            'type': 'newtonian_reflector'},  # Verified via FLO (7.5 kg total weight)
