...
class VixenTelescope(Telescope):
    _DATABASE = {
        'Vixen_VC200L': {
            ...
            'central_obstruction_mm': 77}, # Verified via manufacturer tech specs (77mm CO, 6.0kg OTA)
        'Vixen_VSD100_F3_8': {
            'brand': 'Vixen',
            'name': 'VSD100 F3.8',
            'type': 'type_refractor',
            ...
            'aperture_mm': 100,
            'focal_length_mm': 380,
            'central_obstruction_mm': 0}, # Verified via Vixen Japan (4.5kg OTA)
        'Vixen_SD81S': {
            'brand': 'Vixen',
            'name': 'SD81S',
            'type': 'type_refractor',
            ...
            'aperture_mm': 81,
            'focal_length_mm': 625,
            'central_obstruction_mm': 0}, # Verified via Vixen Japan (2.3kg OTA)
        'Vixen_SD103S': {
            'brand': 'Vixen',
            'name': 'SD103S',
            'type': 'type_refractor',
            ...
            'aperture_mm': 103,
            'focal_length_mm': 795,
            'central_obstruction_mm': 0}, # Verified via Vixen Japan (3.6kg OTA)
        'Vixen_SD115S': {
            'brand': 'Vixen',
            'name': 'SD115S',
            'type': 'type_refractor',
            ...
            'aperture_mm': 115,
            'focal_length_mm': 890,
            'central_obstruction_mm': 0}, # Verified via Vixen Japan (4.4kg OTA)
        'Vixen_AX103S': {
            'brand': 'Vixen',
            'name': 'AX103S',
            'type': 'type_refractor',
            ...
            'aperture_mm': 103,
            'focal_length_mm': 825,
            'central_obstruction_mm': 0}, # Verified via Vixen Japan (4.6kg OTA)
        'Vixen_FL55SS': {
            'brand': 'Vixen',
            'name': 'FL55SS',
            'type': 'type_refractor',
            ...
            'aperture_mm': 55,
            'focal_length_mm': 303,
            'central_obstruction_mm': 0}, # Verified via Vixen Japan (1.5kg OTA)
        'Vixen_R200SS': {
            'brand': 'Vixen',
            'name': 'R200SS',
            ...
            'aperture_mm': 200,
            'focal_length_mm': 800,
            'central_obstruction_mm': 65}, # Verified via Vixen Japan (65mm CO, 5.3kg OTA)
        'Vixen_VMC200L': {
            'brand': 'Vixen',
            'name': 'VMC200L',
            'type': 'catadioptric',
            ...
            'bf_role': '',
            'aperture_mm': 200,
            'focal_length_mm': 1950,
            'central_obstruction_mm': 80}, # Verified via B&H and Vixen (80mm/40% CO, 5.9kg OTA)
    }
