...
class IntermediateOpticalEquipment(OpticalEquipment):
    def __init__(self, vendor, optical_length=0, mass=0, in_connection_type=None, out_connection_type=None):
    ...
    def register(self, equipment):
        ...
        if self.in_connection_type:
            self._register_input(equipment, self.in_connection_type)
        if self.out_connection_type:
            self._register_output(equipment, self.out_connection_type)
