...
class AltairFocuser(Focuser):
    _DATABASE = {'Altair_Starwave_Auto_Focuser': {'brand': 'Altair', 'name':
        'Starwave Auto Focuser', 'type': 'type_focuser', 'optical_length': 
        0, 'mass': 170, 'tside_thread': '', 'tside_gender': 'Male',
