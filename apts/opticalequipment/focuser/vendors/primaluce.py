...
class PrimaLuceFocuser(Focuser):
    _DATABASE = {
        "PrimaLuce_ESATTO_2": {'brand': 'PrimaLuce', 'name': 'ESATTO 2"', 'type': 'type_focuser', 'optical_length': 50, 'mass': 670, 'tside_thread': 'M56', 'tside_gender': 'Male', 'cside_thread': 'M54', 'cside_gender': 'Female', 'reversible': False, 'bf_role': ''},
        "PrimaLuce_ESATTO_3": {'brand': 'PrimaLuce', 'name': 'ESATTO 3"', 'type': 'type_focuser', 'optical_length': 58, 'mass': 1300, 'tside_thread': 'SC (Schmidt-Cassegrain)', 'tside_gender': 'Male', 'cside_thread': 'M68', 'cside_gender': 'Female', 'reversible': False, 'bf_role': ''},
