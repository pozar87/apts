...
class BaaderFocuser(Focuser):
    _DATABASE = {'Baader_Steeldrive_II': {'brand': 'Baader', 'name':
        'Steeldrive II', 'type': 'type_focuser', 'optical_length': 0,
        'mass': 350, 'tside_thread': '', 'tside_gender': 'Male',
        'cside_thread': '', 'cside_gender': 'Female', 'reversible': False,
        'bf_role': ''}, 'Baader_Diamond_Steeltrack': {'brand': 'Baader',
        'name': 'Diamond Steeltrack', 'type': 'type_focuser',
        'optical_length': 0, 'mass': 600, 'tside_thread': 'M54',
