...
class BaaderFocuser(Focuser):
    _DATABASE = {
        ...
        "Baader_Diamond_Steeltrack": {'brand': 'Baader', 'name': 'Diamond Steeltrack', 'type': 'type_focuser', 'optical_length': 0, 'mass': 600, 'tside_thread': 'M54', 'tside_gender': 'Male', 'cside_thread': 'M54', 'cside_gender': 'Female', 'reversible': False, 'bf_role': ''},
    }
