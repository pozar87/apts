...
class Player_oneCamera(Camera):
    ...
    @classmethod
    def Player_One_Xena_585M(cls):
        return cls.from_database(cls._DATABASE["Player_One_Xena_585M"])

    @classmethod
    def Player_One_Ceres_462M(cls):
        return cls.from_database(cls._DATABASE["Player_One_Ceres_462M"])
    ...
    @classmethod
    def Player_One_Uranus_C_Pro(cls):
        return cls.from_database(cls._DATABASE["Player_One_Uranus_C_Pro"])

    @classmethod
    def Player_One_Xena_M_Pro(cls):
        return cls.from_database(cls._DATABASE["Player_One_Xena_M_Pro"])
