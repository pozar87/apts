...
class QhyCamera(Camera):
    _DATABASE = {
        ...
        'QHY_QHY_268C': {
            ...
            'name': 'QHY 268C',
            'type': 'type_camera',
            'optical_length': 17.5, # Verified PH version + standard adapter
            'mass': 780,  # Verified OTA weight via QHY manual
            'tside_thread': 'M54',
            'tside_gender': 'Female',
            'cside_thread': '',
            'cside_gender': '',
            ...
            'height': 4176,
            'pixel_size_um': 3.76,
            'quantum_efficiency_pct': 80,  # Verified BSI peak QE
            'read_noise_e': 1.1,
            'full_well_e': 51000
        },
        ...
        'QHY_QHY_600C': {
            ...
            'type': 'type_camera',
            'optical_length': 17.5,
            'mass': 900,  # Verified OTA weight for 600 series (PH version)
            'tside_thread': 'M54',
            'tside_gender': 'Female',
            'cside_thread': '',
            'cside_gender': '',
