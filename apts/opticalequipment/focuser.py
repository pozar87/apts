...
class Focuser(IntermediateOpticalEquipment):
    ...
    _DATABASE = {
        ...
        "Moonlite_CSL_2_5_Focuser": {
            "brand": "Moonlite",
            "name": 'CSL 2.5" Focuser',
            "type": "type_focuser",
            "optical_length": 0,
            "mass": 1100,
            "tside_thread": "",
        ...
        "GSO_2_Crayford_Focuser": {
            "brand": "GSO",
            "name": '2" Crayford Focuser',
            "type": "type_focuser",
            "optical_length": 0,
            "mass": 600,
            "tside_thread": "",
        ...
        "GSO_2_Dual_Speed_Focuser": {
            "brand": "GSO",
            "name": '2" Dual-Speed Focuser',
            "type": "type_focuser",
            "optical_length": 0,
            "mass": 650,
            "tside_thread": "",
        ...
        "TS_Optics_3_Rack_Pinion_Focuser": {
            "brand": "TS-Optics",
            "name": '3" Rack & Pinion Focuser',
            "type": "type_focuser",
            "optical_length": 0,
            "mass": 1000,
            "tside_thread": "M68",
    ...
    def Starlight_Instruments_Feather_Touch_2_5(cls):
        return cls.from_database(
            cls._DATABASE["Starlight_Instruments_Feather_Touch_2_5"]
        )
    ...
    def Starlight_Instruments_Feather_Touch_3_5(cls):
        return cls.from_database(
            cls._DATABASE["Starlight_Instruments_Feather_Touch_3_5"]
        )
