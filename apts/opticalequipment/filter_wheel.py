...
class FilterWheel(IntermediateOpticalEquipment):
    ...
    _DATABASE = {
        ...
        "Lacerta_Filter_Wheel_M42": {
            "brand": "Lacerta",
            "name": "Filter Wheel (M42)",
            "type": "type_filter_wheel",
            "optical_length": 20,
            "mass": 350,
            "tside_thread": "M42",
        ...
        "Lacerta_Filter_Wheel_M54": {
            "brand": "Lacerta",
            "name": "Filter Wheel (M54)",
            "type": "type_filter_wheel",
            "optical_length": 20,
            "mass": 550,
            "tside_thread": "M54",
        ...
        "SVBony_SV222_FW_5x1_25_M42": {
            "brand": "SVBony",
            "name": 'SV222 FW 5x1.25" (M42)',
            "type": "type_filter_wheel",
            "optical_length": 18,
            "mass": 220,
            "tside_thread": "M42",
        ...
        "SVBony_SV222_FW_7x_M48": {
            "brand": "SVBony",
            "name": "SV222 FW 7x (M48)",
            "type": "type_filter_wheel",
            "optical_length": 20,
            "mass": 380,
            "tside_thread": "M48",
        ...
        "Meade_Series_6000_FW_M42": {
            "brand": "Meade",
            "name": "Series 6000 FW (M42)",
            "type": "type_filter_wheel",
            "optical_length": 19,
            "mass": 320,
            "tside_thread": "M42",
    ...
    def Explore_Scientific_Filter_Wheel_5x_M42(cls):
        return cls.from_database(
            cls._DATABASE["Explore_Scientific_Filter_Wheel_5x_M42"]
        )

    @classmethod
    def Explore_Scientific_Filter_Wheel_7x_M48(cls):
        return cls.from_database(
            cls._DATABASE["Explore_Scientific_Filter_Wheel_7x_M48"]
        )
...
class FilterHolder(IntermediateOpticalEquipment):
    ...
    _DATABASE = {
        ...
        "Baader_Filter_Slider_M48": {
            "brand": "Baader",
            "name": "Filter Slider (M48)",
            "type": "type_filter_holder",
            "optical_length": 8,
            "mass": 150,
            "tside_thread": "M48",
        ...
        "Baader_Filter_Slider_M54": {
            "brand": "Baader",
            "name": "Filter Slider (M54)",
            "type": "type_filter_holder",
            "optical_length": 8,
            "mass": 170,
            "tside_thread": "M54",
        ...
        "Baader_Filter_Slider_M42": {
            "brand": "Baader",
            "name": "Filter Slider (M42)",
            "type": "type_filter_holder",
            "optical_length": 8,
            "mass": 130,
            "tside_thread": "M42",
        ...
        "IDAS_Filter_Holder_M48": {
            "brand": "IDAS",
            "name": "Filter Holder (M48)",
            "type": "type_filter_holder",
            "optical_length": 8,
            "mass": 120,
            "tside_thread": "M48",
        ...
        "SVBony_Filter_Drawer_M42": {
            "brand": "SVBony",
            "name": "Filter Drawer (M42)",
            "type": "type_filter_holder",
            "optical_length": 20,
            "mass": 150,
            "tside_thread": "M42",
