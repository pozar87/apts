...
class AntiTilt(IntermediateOpticalEquipment):
    def __init__(self, vendor, optical_length=0, mass=0, in_connection_type=None, out_connection_type=None, in_gender=None, out_gender=None):
        super(AntiTilt, self).__init__(vendor, optical_length=optical_length, mass=mass, in_connection_type=in_connection_type, out_connection_type=out_connection_type)
        self._type = OpticalType.ANTI_TILT
        self.in_gender = in_gender
        self.out_gender = out_gender

    def register(self, equipment):
        super(AntiTilt, self)._register(equipment)
