...
class ExploreScientificAntiTilt(AntiTilt):
    _DATABASE = {'Explore_Scientific_Tilt_Adjuster_M48': {'brand':
        'Explore Scientific', 'name': 'Tilt Adjuster (M48)', 'type':
        'type_anti_tilt', 'optical_length': 6, 'mass': 50, 'tside_thread':
