...
class AltairAntiTilt(AntiTilt):
    _DATABASE = {'Altair_Tilt_Adjuster_M42': {'brand': 'Altair', 'name':
        'Tilt Adjuster (M42)', 'type': 'type_anti_tilt', 'optical_length': 
        5, 'mass': 40, 'tside_thread': 'M42', 'tside_gender': 'Female',
        'cside_thread': 'M42', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Altair_Tilt_Adjuster_M48': {'brand': 'Altair',
