...
class OmegonAntiTilt(AntiTilt):
    _DATABASE = {'Omegon_Tilt_Adjuster_M42': {'brand': 'Omegon', 'name':
        'Tilt Adjuster (M42)', 'type': 'type_anti_tilt', 'optical_length': 
        5, 'mass': 38, 'tside_thread': 'M42', 'tside_gender': 'Female',
        'cside_thread': 'M42', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Omegon_Tilt_Adjuster_M48': {'brand': 'Omegon',
        'name': 'Tilt Adjuster (M48)', 'type': 'type_anti_tilt',
        'optical_length': 6, 'mass': 48, 'tside_thread': 'M48',
