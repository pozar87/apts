...
class AskarAntiTilt(AntiTilt):
    _DATABASE = {'Askar_Tilt_Adjuster_M48': {'brand': 'Askar', 'name':
        'Tilt Adjuster (M48)', 'type': 'type_anti_tilt', 'optical_length': 
        6, 'mass': 50, 'tside_thread': 'M48', 'tside_gender': 'Female',
        'cside_thread': 'M48', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Askar_Tilt_Adjuster_M54': {'brand': 'Askar',
        'name': 'Tilt Adjuster (M54)', 'type': 'type_anti_tilt',
        'optical_length': 8, 'mass': 60, 'tside_thread': 'M54',
