...
class ApmEyepiece(Eyepiece):
    _DATABASE = {       'APM_HDC_12mm': {       'bf_role': '',
                                'brand': 'APM',
                                'cside_gender': '',
                                'cside_thread': '',
        ...
        'APM_Plossl_6_5mm': {       'bf_role': '',
                                    ...
                                    'tside_thread': '1.25"',
                                    'type': 'type_eyepiece'},
        'APM_UFF_10mm': {       'bf_role': '',
                                'brand': 'APM',
                                'cside_gender': '',
                                'cside_thread': '',
                                'field_of_view_deg': 65,
                                'focal_length_mm': 10.0,
                                'mass': 250,
                                'name': 'UFF 10mm',
                                'optical_length': 0,
