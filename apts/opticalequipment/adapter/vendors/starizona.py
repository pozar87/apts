...
class StarizonaAdapter(Adapter):
    _DATABASE = {
        ...
        "Starizona_SCT_M54_Adapter": {
            "brand": "Starizona",
            "name": "SCT→M54 Adapter",
            "type": "type_adapter",
            "optical_length": 15,
            "mass": 60,
            "tside_thread": "SC (Schmidt-Cassegrain)",
