...
class GsoAdapter(Adapter):
    _DATABASE = {
        ...
        "GSO_SC_1_25_Visual_Back": {
            "brand": "GSO",
            "name": "SC→1.25\" Visual Back",
            "type": "type_adapter",
            "optical_length": 30,
            "mass": 40,
            "tside_thread": "SC (Schmidt-Cassegrain)",
