...
class Astro_physicsAdapter(Adapter):
    _DATABASE = {
        ...
        "Astro_Physics_M68_Nikon_F_Adapter": {
            "brand": "Astro-Physics",
            "name": "M68→Nikon F Adapter",
            "type": "type_adapter",
            "optical_length": 10,
            "mass": 40,
        ...
        "Astro_Physics_M68_Sony_E_Adapter": {
            "brand": "Astro-Physics",
        ...
        "Astro_Physics_M68_Canon_RF_Adapter": {
            "brand": "Astro-Physics",
