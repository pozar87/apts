...
class OrionAdapter(Adapter):
    _DATABASE = {
        ...
        "Orion_Visual_Back_1_25": {
            "brand": "Orion",
            "name": "Visual Back (1.25\")",
            "type": "type_adapter",
            "optical_length": 35,
            "mass": 45,
            "tside_thread": "SC (Schmidt-Cassegrain)",
