...
class OmegonAdapter(Adapter):
    _DATABASE = {'Omegon_M42_Spacer_5mm': {'brand': 'Omegon', 'name':
        ...
        'bf_role': ''}, 'Omegon_M48_M54_Adapter': {'brand': 'Omegon',
        ...
        'bf_role': ''}, 'Omegon_M54_M68_Adapter': {'brand': 'Omegon',
        ...
        'bf_role': ''}, 'Omegon_T2_Ring_Canon_EOS': {'brand': 'Omegon',
        'name': 'T2 Ring Canon EOS', 'type': 'type_adapter',
        ...
        'Omegon_T2_Ring_Nikon_F': {'brand': 'Omegon', 'name':
        'T2 Ring Nikon F', 'type': 'type_adapter', 'optical_length': 8.5,
        'mass': 25, 'tside_thread': 'Nikon F', 'tside_gender': 'Female',
        'cside_thread': 'M42', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Omegon_T2_Ring_Sony_E': {'brand': 'Omegon', 'name':
        'T2 Ring Sony E', 'type': 'type_adapter', 'optical_length': 7,
        'mass': 25, 'tside_thread': 'Sony E', 'tside_gender': 'Female',
        'cside_thread': 'M42', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Omegon_T2_Ring_Fuji_X': {'brand': 'Omegon', 'name':
        'T2 Ring Fuji X', 'type': 'type_adapter', 'optical_length': 7,
        'mass': 25, 'tside_thread': 'Fuji X', 'tside_gender': 'Female',
        'cside_thread': 'M42', 'cside_gender': 'Male', 'reversible': False,
        'bf_role': ''}, 'Omegon_T2_Ring_MFT': {'brand': 'Omegon', 'name':
        'T2 Ring MFT', 'type': 'type_adapter', 'optical_length': 7, 'mass':
        20, 'tside_thread': 'MFT', 'tside_gender': 'Female', 'cside_thread':
        'M42', 'cside_gender': 'Male', 'reversible': False, 'bf_role': ''},
        'Omegon_M54_Spacer_5mm': {'brand': 'Omegon', 'name':
