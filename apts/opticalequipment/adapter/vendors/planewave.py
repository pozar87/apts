...
class PlanewaveAdapter(Adapter):
    _DATABASE = {
        ...
        "PlaneWave_M117_M54_Adapter": {
            "brand": "PlaneWave",
            "name": "M117→M54 Adapter",
            "type": "type_adapter",
            "optical_length": 20,
            "mass": 55,
            "tside_thread": "M54",
        ...
        "PlaneWave_M117_M42_Adapter": {
            "brand": "PlaneWave",
            "name": "M117→M42 Adapter",
            "type": "type_adapter",
            "optical_length": 25,
            "mass": 50,
            "tside_thread": "M42",
        ...
        "PlaneWave_M117_EOS_Adapter": {
            "brand": "PlaneWave",
            "name": "M117→EOS Adapter",
            "type": "type_adapter",
            "optical_length": 20,
            "mass": 55,
            "tside_thread": "EOS",
        ...
        "PlaneWave_M117_Sony_E_Adapter": {
            "brand": "PlaneWave",
            "name": "M117→Sony E Adapter",
            "type": "type_adapter",
            "optical_length": 18,
            "mass": 50,
            "tside_thread": "Sony E",
        ...
        "PlaneWave_M117_M72_Adapter": {
            "brand": "PlaneWave",
            "name": "M117→M72 Adapter",
            "type": "type_adapter",
            "optical_length": 10,
            "mass": 50,
            "tside_thread": "M72",
