...
class HutechAdapter(Adapter):
    _DATABASE = {'Hutech_M42_Spacer_2_5mm': {'brand': 'Hutech', 'name':
        ...
        'Male', 'reversible': True, 'bf_role': ''}, 'Hutech_M48_Spacer_3mm':
        {'brand': 'Hutech', 'name': 'M48 Spacer 3mm', 'type':
        ...
        'Hutech_M48_Spacer_4mm': {'brand': 'Hutech', 'name':
