...
def _get_jovian_mutual_state(t, observer, jupiter, sun, id1, id2, m1_obj, m2_obj, ts):
...
def find_jovian_mutual_events(observer, start_date, end_date):
    ...
    for i, id1 in enumerate(moon_ids):
        for id2 in moon_ids[i + 1 :]:
            ...
            def mutual_state(t):
                return _get_jovian_mutual_state(t, observer, jupiter, sun, id1, id2, m1_obj, m2_obj, ts)
