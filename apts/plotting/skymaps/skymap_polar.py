...
def _plot_polar_horizontal_overlay(
    ...
    """Plots the horizontal overlay (horizon line and shading, or altitude/azimuth limits) on the skymap."""
...
def _plot_polar_equatorial_overlay(
    ...
    """Plots the equatorial overlay (contour of visible sky) on the polar skymap."""
    num_ra = 120
    num_dec = 30
...
def _plot_polar_visibility_overlay(
    ...
    if coordinate_system == CoordinateSystem.HORIZONTAL:
        _plot_polar_horizontal_overlay(
            observation,
            ax,
            style,
        ...
        _plot_polar_equatorial_overlay(
            observation,
            ax,
            observer,
            is_sh,
